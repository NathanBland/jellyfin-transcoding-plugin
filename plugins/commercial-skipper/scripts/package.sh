...
PROJECT="$ROOT_DIR/src/Jellyfin.Plugin.CommercialSkipper/Jellyfin.Plugin.CommercialSkipper.csproj"
PUBLISH_DIR="$ROOT_DIR/artifacts/publish"
STAGING_DIR="$ROOT_DIR/artifacts/package"
ARCHIVE="$ROOT_DIR/artifacts/commercial-skipper_${VERSION}.zip"
...
cp "$PUBLISH_DIR/Jellyfin.Plugin.CommercialSkipper.dll" "$STAGING_DIR/"
zip -q -j "$ARCHIVE" "$STAGING_DIR/Jellyfin.Plugin.CommercialSkipper.dll"
